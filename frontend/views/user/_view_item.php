    ...
    <dl class="dl-horizontal">
        ...
        <?php if(trim($model->username)!=''): ?>
            ...
            <dd><span class="text-info">
                <a href="<?=Yii::$app->urlManager->createUrl(['/users/view', 'id' => $model->id]);?>">
        ...
        <dt>&nbsp;</dt>
        <dd>
            <a href="<?=Yii::$app->urlManager->createUrl(['/users/view', 'id' => $model->id]);?>" id="" type="button" class=" btn btn-primary btn-mini pull-right"><?=Yii::t('app', 'Details')?></a>
        </dd>
